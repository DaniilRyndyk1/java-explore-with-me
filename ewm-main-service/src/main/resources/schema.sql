...
ALTER TABLE events ADD CONSTRAINT events_location_fk FOREIGN KEY (location_id)
REFERENCES users (id) ON UPDATE CASCADE ON DELETE CASCADE;

ALTER TABLE events ADD CONSTRAINT events_users_fk FOREIGN KEY (initiator_id)
